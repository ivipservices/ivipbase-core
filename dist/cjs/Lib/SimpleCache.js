...
class SimpleCache {
    ...
    get(key) {
        ...
        entry.expires = calculateExpiryTime((_a = this.options.expirySeconds) !== null && _a !== void 0 ? _a : this.defaultExpirySeconds);
    ...
    set(key, value) {
        ...
        this.cache.set(key, {
            ...
            added: Date.now(),
            accessed: Date.now(),
            expires: calculateExpiryTime((_a = this.options.expirySeconds) !== null && _a !== void 0 ? _a : this.defaultExpirySeconds),
        });
    }
    remove(key) {
        this.cache.delete(key);
