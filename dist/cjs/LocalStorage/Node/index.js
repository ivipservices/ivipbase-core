...
const Ascii85_1 = __importDefault(require("../../Lib/Ascii85"));
...
class Node {
        ...
        if (options.include_child_count && containsChild) {
            ...
            if ([exports.VALUE_TYPES.OBJECT, exports.VALUE_TYPES.ARRAY].includes(info.valueType) && info.address) {
                ...
                info.childCount += this.nodes
                    ...
                    .map(({ path }) => { var _a; return (_a = PathInfo_1.default.get(path.replace(new RegExp(`^${pathInfo.path}`, "gi"), "")).keys[1]) !== null && _a !== void 0 ? _a : ""; })
    ...
    exportJson(nodes, onlyChildren = false, includeChildrenDedicated = true) {
        ...
        let revision = (_c = ((_b = (_a = byNodes[0]) === null || _a === void 0 ? void 0 : _a.content) !== null && _b !== void 0 ? _b : {}).revision) !== null && _c !== void 0 ? _c : ID_1.default.generate();
        const rootNode = {
            path: PathInfo_1.default.get(byPathRoot !== null && byPathRoot !== void 0 ? byPathRoot : "").path,
            content: {
                type: 1,
                value: {},
                revision: revision,
