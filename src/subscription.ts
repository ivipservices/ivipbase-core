...
export class EventSubscription {
    /**
     * Interrompe a assinatura para não receber eventos futuros
     */
    ...
    /**
     * @param stop função que interrompe a assinatura para não receber eventos futuros
     */
    ...
    /**
     * Notifica quando a assinatura é ativada ou cancelada
     * @param callback callback opcional para ser executado cada vez que o estado de ativação mudar
     * @returns retorna uma promise que é resolvida quando ativada, ou é rejeitada quando é negada (e nenhum callback foi fornecido)
     */
    activated(callback?:(activated: boolean, cancelReason?: string) => void): Promise<void> {
        ...
        // Comportamento alterado: agora também retorna uma Promise quando o callback é usado.
        // Isso permite que uma chamada ativada trate tanto o resultado da primeira ativação quanto
        // quaisquer eventos futuros usando o callback.
